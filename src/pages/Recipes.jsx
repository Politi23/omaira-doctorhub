...
async function imprimirRecipe(recipe, paciente) {
  ...
  const validador = recipe.codigo ? `
    <div class="validador">
      ${qrSvg ? `<div class="qr">${qrSvg}</div>` : ''}
      <p class="val-cod">Código Validador: <b>${recipe.codigo}</b></p>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Bloque antifalsificación: QR arriba y código centrado debajo. */
    .validador { flex-shrink: 0; width: 30mm; text-align: center; }
    .validador .qr { width: 22mm; height: 22mm; margin: 0 auto; }
